...
namespace TechFoodClean.Application.Interfaces.Presenter
{
    public partial class ImageUrlResolver : IImageUrlResolver
    {
        ...
        public string BuildFilePath(string folderName, string imageFileName)
        {
            ...
            {
                throw new TechFoodClean.Common.Exceptions.ApplicationException(Exceptions.ImageUrlResolver_FolderCannotBeNull);
            }
